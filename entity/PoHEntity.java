...
import net.mcreator.swordcraftonline.item.MateChopperItem;
...
import net.mcreator.swordcraftonline.entity.renderer.PoHRenderer;
...
@Tag
public class PoHEntity extends SwordcraftonlineModElements.ModElement
{
    public static EntityType entity;
    
    public PoHEntity(final SwordcraftonlineModElements instance) {
        super(instance, 237);
        FMLJavaModLoadingContext.get().getModEventBus().register((Object)new PoHRenderer.ModelRegisterHandler());
    ...
    public void initElements() {
        this.elements.entities.add(() -> PoHEntity.entity);
        final SpawnEggItem spawnEggItem;
        this.elements.items.add(() -> {
            new SpawnEggItem(PoHEntity.entity, -14212068, -11726318, new Item.Properties().func_200916_a(ItemGroup.field_78026_f));
            return (Item)spawnEggItem.setRegistryName("po_h_spawn_egg");
        });
    }
    ...
    public void addFeatureToBiomes(final BiomeLoadingEvent event) {
        ...
        event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(PoHEntity.entity, 18, 1, 1));
    }
    
    @Override
    public void init(final FMLCommonSetupEvent event) {
        EntitySpawnPlacementRegistry.func_209343_a(PoHEntity.entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::func_223324_d);
    }
    
    static {
        PoHEntity.entity = (EntityType)EntityType.Builder.func_220322_a(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setUpdateInterval(3).setCustomClientFactory((BiFunction)CustomEntity::new).func_220321_a(0.6f, 1.8f).func_206830_a("po_h").setRegistryName("po_h");
    }
    ...
    public static class CustomEntity extends MonsterEntity
    {
        public CustomEntity(final FMLPlayMessages.SpawnEntity packet, final World world) {
            this((EntityType<CustomEntity>)PoHEntity.entity, world);
        }
        ...
        public CustomEntity(final EntityType<CustomEntity> type, final World world) {
            ...
            this.func_200203_b((ITextComponent)new StringTextComponent("PoH"));
            this.func_174805_g(true);
            this.func_184201_a(EquipmentSlotType.MAINHAND, new ItemStack((IItemProvider)MateChopperItem.block));
        }
