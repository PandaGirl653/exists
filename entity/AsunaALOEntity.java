...
import net.mcreator.swordcraftonline.entity.renderer.AsunaALORenderer;
...
@Tag
public class AsunaALOEntity extends SwordcraftonlineModElements.ModElement
{
    public static EntityType entity;
    
    public AsunaALOEntity(final SwordcraftonlineModElements instance) {
        super(instance, 232);
        FMLJavaModLoadingContext.get().getModEventBus().register((Object)new AsunaALORenderer.ModelRegisterHandler());
    ...
    public void initElements() {
        this.elements.entities.add(() -> AsunaALOEntity.entity);
        final SpawnEggItem spawnEggItem;
        this.elements.items.add(() -> {
            new SpawnEggItem(AsunaALOEntity.entity, -251864, -22471, new Item.Properties().func_200916_a(ItemGroup.field_78026_f));
            return (Item)spawnEggItem.setRegistryName("asuna_alo_spawn_egg");
        });
    }
    ...
    public void addFeatureToBiomes(final BiomeLoadingEvent event) {
        ...
        if (new ResourceLocation("the_end").equals((Object)event.getName())) {
            biomeCriteria = true;
        }
        if (!biomeCriteria) {
            return;
        }
        event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(AsunaALOEntity.entity, 1, 1, 1));
    }
    
    @Override
    public void init(final FMLCommonSetupEvent event) {
        EntitySpawnPlacementRegistry.func_209343_a(AsunaALOEntity.entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.func_180495_p(pos.func_177977_b()).func_185904_a() == Material.field_151577_b && world.func_226659_b_(pos, 0) > 8);
    }
    
    static {
        AsunaALOEntity.entity = (EntityType)EntityType.Builder.func_220322_a(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setUpdateInterval(3).setCustomClientFactory((BiFunction)CustomEntity::new).func_220321_a(0.6f, 1.8f).func_206830_a("asuna_alo").setRegistryName("asuna_alo");
    }
    ...
    public static class CustomEntity extends CreatureEntity
    {
        public CustomEntity(final FMLPlayMessages.SpawnEntity packet, final World world) {
            this((EntityType<CustomEntity>)AsunaALOEntity.entity, world);
        }
