...
import net.mcreator.swordcraftonline.entity.renderer.XaXaRenderer;
...
@Tag
public class XaXaEntity extends SwordcraftonlineModElements.ModElement
{
    public static EntityType entity;
    
    public XaXaEntity(final SwordcraftonlineModElements instance) {
        super(instance, 238);
        FMLJavaModLoadingContext.get().getModEventBus().register((Object)new XaXaRenderer.ModelRegisterHandler());
    ...
    public void initElements() {
        this.elements.entities.add(() -> XaXaEntity.entity);
        final SpawnEggItem spawnEggItem;
        this.elements.items.add(() -> {
            new SpawnEggItem(XaXaEntity.entity, -14672868, -14611958, new Item.Properties().func_200916_a(ItemGroup.field_78026_f));
            return (Item)spawnEggItem.setRegistryName("xa_xa_spawn_egg");
        });
    }
    ...
    public void addFeatureToBiomes(final BiomeLoadingEvent event) {
        ...
        event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(XaXaEntity.entity, 15, 1, 1));
    }
    
    @Override
    public void init(final FMLCommonSetupEvent event) {
        EntitySpawnPlacementRegistry.func_209343_a(XaXaEntity.entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::func_223324_d);
    }
    
    static {
        XaXaEntity.entity = (EntityType)EntityType.Builder.func_220322_a(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setUpdateInterval(3).setCustomClientFactory((BiFunction)CustomEntity::new).func_220321_a(0.6f, 1.8f).func_206830_a("xa_xa").setRegistryName("xa_xa");
    }
    ...
    private static class EntityAttributesRegisterHandler
    {
        ...
        public void onEntityAttributeCreation(final EntityAttributeCreationEvent event) {
            ...
            event.put(XaXaEntity.entity, ammma.func_233813_a_());
        }
    }
    ...
    public static class CustomEntity extends MonsterEntity
    {
        public CustomEntity(final FMLPlayMessages.SpawnEntity packet, final World world) {
            this((EntityType<CustomEntity>)XaXaEntity.entity, world);
        }
        ...
        public CustomEntity(final EntityType<CustomEntity> type, final World world) {
            ...
            this.func_200203_b((ITextComponent)new StringTextComponent("XaXa"));
