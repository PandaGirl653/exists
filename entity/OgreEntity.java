...
import net.mcreator.swordcraftonline.entity.renderer.OgreRenderer;
...
@Tag
public class OgreEntity extends SwordcraftonlineModElements.ModElement
{
    public static EntityType entity;
    
    public OgreEntity(final SwordcraftonlineModElements instance) {
        super(instance, 308);
        FMLJavaModLoadingContext.get().getModEventBus().register((Object)new OgreRenderer.ModelRegisterHandler());
    ...
    public void initElements() {
        this.elements.entities.add(() -> OgreEntity.entity);
        final SpawnEggItem spawnEggItem;
        this.elements.items.add(() -> {
            new SpawnEggItem(OgreEntity.entity, -12890864, -15457022, new Item.Properties().func_200916_a(ItemGroup.field_78026_f));
            return (Item)spawnEggItem.setRegistryName("ogre_spawn_egg");
        });
    }
    ...
    public void addFeatureToBiomes(final BiomeLoadingEvent event) {
        ...
        if (new ResourceLocation("wooded_hills").equals((Object)event.getName())) {
            biomeCriteria = true;
        }
        if (new ResourceLocation("tall_birch_forest").equals((Object)event.getName())) {
            biomeCriteria = true;
        }
        if (new ResourceLocation("warped_forest").equals((Object)event.getName())) {
            biomeCriteria = true;
        }
        if (!biomeCriteria) {
            return;
        }
        event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(OgreEntity.entity, 30, 1, 6));
    }
    
    @Override
    public void init(final FMLCommonSetupEvent event) {
        EntitySpawnPlacementRegistry.func_209343_a(OgreEntity.entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::func_223324_d);
        DungeonHooks.addDungeonMob(OgreEntity.entity, 180);
    }
    
    static {
        OgreEntity.entity = (EntityType)EntityType.Builder.func_220322_a(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setUpdateInterval(3).setCustomClientFactory((BiFunction)CustomEntity::new).func_220321_a(0.6f, 1.8f).func_206830_a("ogre").setRegistryName("ogre");
    }
    ...
    private static class EntityAttributesRegisterHandler
    {
        ...
        public void onEntityAttributeCreation(final EntityAttributeCreationEvent event) {
            ...
            ammma = ammma.func_233815_a_(Attributes.field_233826_i_, 25.0);
            ...
            event.put(OgreEntity.entity, ammma.func_233813_a_());
        }
    }
    ...
    public static class CustomEntity extends MonsterEntity
    {
        public CustomEntity(final FMLPlayMessages.SpawnEntity packet, final World world) {
            this((EntityType<CustomEntity>)OgreEntity.entity, world);
        }
        ...
        protected void func_184651_r() {
            ...
            this.field_70715_bh.func_75776_a(3, (Goal)new NearestAttackableTargetGoal((MobEntity)this, (Class)WolfEntity.class, true, false));
