...
import net.mcreator.swordcraftonline.entity.renderer.DarkKnightRenderer;
...
@Tag
public class DarkKnightEntity extends SwordcraftonlineModElements.ModElement
{
    public static EntityType entity;
    
    public DarkKnightEntity(final SwordcraftonlineModElements instance) {
        super(instance, 250);
        FMLJavaModLoadingContext.get().getModEventBus().register((Object)new DarkKnightRenderer.ModelRegisterHandler());
        FMLJavaModLoadingContext.get().getModEventBus().register((Object)new EntityAttributesRegisterHandler());
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> DarkKnightEntity.entity);
        final SpawnEggItem spawnEggItem;
        this.elements.items.add(() -> {
            new SpawnEggItem(DarkKnightEntity.entity, -16185079, -3898619, new Item.Properties().func_200916_a(ItemGroup.field_78026_f));
            return (Item)spawnEggItem.setRegistryName("dark_knight_spawn_egg");
        });
    }
    ...
    static {
        DarkKnightEntity.entity = (EntityType)EntityType.Builder.func_220322_a(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setUpdateInterval(3).setCustomClientFactory((BiFunction)CustomEntity::new).func_220320_c().func_220321_a(0.6f, 1.8f).func_206830_a("dark_knight").setRegistryName("dark_knight");
    }
    ...
    private static class EntityAttributesRegisterHandler
    {
        ...
        public void onEntityAttributeCreation(final EntityAttributeCreationEvent event) {
            ...
            ammma = ammma.func_233815_a_(Attributes.field_233818_a_, 700.0);
            ammma = ammma.func_233815_a_(Attributes.field_233826_i_, 35.0);
            ammma = ammma.func_233815_a_(Attributes.field_233823_f_, 25.0);
            ammma = ammma.func_233815_a_(Attributes.field_233820_c_, 0.7999999999999999);
            event.put(DarkKnightEntity.entity, ammma.func_233813_a_());
        }
    }
    ...
    public static class CustomEntity extends MonsterEntity
    {
        ...
        public CustomEntity(final FMLPlayMessages.SpawnEntity packet, final World world) {
            this((EntityType<CustomEntity>)DarkKnightEntity.entity, world);
        }
        ...
        public CustomEntity(final EntityType<CustomEntity> type, final World world) {
            ...
            this.func_200203_b((ITextComponent)new StringTextComponent("Dark Knight"));
        ...
        public boolean func_70097_a(final DamageSource source, final float amount) {
            return !(source.func_76364_f() instanceof AbstractArrowEntity) && !(source.func_76364_f() instanceof PotionEntity) && source != DamageSource.field_76367_g && super.func_70097_a(source, amount);
        }
