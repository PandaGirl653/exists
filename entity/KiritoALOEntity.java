...
import net.mcreator.swordcraftonline.entity.renderer.KiritoALORenderer;
...
@Tag
public class KiritoALOEntity extends SwordcraftonlineModElements.ModElement
{
    public static EntityType entity;
    
    public KiritoALOEntity(final SwordcraftonlineModElements instance) {
        super(instance, 252);
        FMLJavaModLoadingContext.get().getModEventBus().register((Object)new KiritoALORenderer.ModelRegisterHandler());
        FMLJavaModLoadingContext.get().getModEventBus().register((Object)new EntityAttributesRegisterHandler());
    }
    
    @Override
    public void initElements() {
        this.elements.entities.add(() -> KiritoALOEntity.entity);
        final SpawnEggItem spawnEggItem;
        this.elements.items.add(() -> {
            new SpawnEggItem(KiritoALOEntity.entity, -14342875, -6316129, new Item.Properties().func_200916_a(ItemGroup.field_78026_f));
            return (Item)spawnEggItem.setRegistryName("kirito_alo_spawn_egg");
        });
    }
    ...
    static {
        KiritoALOEntity.entity = (EntityType)EntityType.Builder.func_220322_a(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setUpdateInterval(3).setCustomClientFactory((BiFunction)CustomEntity::new).func_220320_c().func_220321_a(0.6f, 1.8f).func_206830_a("kirito_alo").setRegistryName("kirito_alo");
    }
    ...
    private static class EntityAttributesRegisterHandler
    {
        ...
        public void onEntityAttributeCreation(final EntityAttributeCreationEvent event) {
            ...
            ammma = ammma.func_233815_a_(Attributes.field_233818_a_, 800.0);
            ammma = ammma.func_233815_a_(Attributes.field_233826_i_, 40.0);
            ammma = ammma.func_233815_a_(Attributes.field_233823_f_, 28.0);
            ammma = ammma.func_233815_a_(Attributes.field_233820_c_, 0.7);
            event.put(KiritoALOEntity.entity, ammma.func_233813_a_());
        }
    }
    ...
    public static class CustomEntity extends MonsterEntity
    {
        ...
        public CustomEntity(final FMLPlayMessages.SpawnEntity packet, final World world) {
            this((EntityType<CustomEntity>)KiritoALOEntity.entity, world);
        }
        ...
        public boolean func_70097_a(final DamageSource source, final float amount) {
            return !(source.func_76364_f() instanceof AbstractArrowEntity) && !(source.func_76364_f() instanceof PotionEntity) && source != DamageSource.field_76379_h && source != DamageSource.field_76367_g && source != DamageSource.field_76369_e && source != DamageSource.field_180137_b && !source.func_94541_c() && super.func_70097_a(source, amount);
        }
