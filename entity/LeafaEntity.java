...
import net.mcreator.swordcraftonline.entity.renderer.LeafaRenderer;
...
@Tag
public class LeafaEntity extends SwordcraftonlineModElements.ModElement
{
    public static EntityType entity;
    
    public LeafaEntity(final SwordcraftonlineModElements instance) {
        super(instance, 235);
        FMLJavaModLoadingContext.get().getModEventBus().register((Object)new LeafaRenderer.ModelRegisterHandler());
    ...
    public void initElements() {
        this.elements.entities.add(() -> LeafaEntity.entity);
        final SpawnEggItem spawnEggItem;
        this.elements.items.add(() -> {
            new SpawnEggItem(LeafaEntity.entity, -10944662, -5832934, new Item.Properties().func_200916_a(ItemGroup.field_78026_f));
            return (Item)spawnEggItem.setRegistryName("leafa_spawn_egg");
        });
    }
    ...
    public void addFeatureToBiomes(final BiomeLoadingEvent event) {
        ...
        if (new ResourceLocation("sunflower_plains").equals((Object)event.getName())) {
            biomeCriteria = true;
        }
        if (!biomeCriteria) {
            return;
        }
        event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(LeafaEntity.entity, 1, 1, 1));
    }
    
    @Override
    public void init(final FMLCommonSetupEvent event) {
        EntitySpawnPlacementRegistry.func_209343_a(LeafaEntity.entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.func_180495_p(pos.func_177977_b()).func_185904_a() == Material.field_151577_b && world.func_226659_b_(pos, 0) > 8);
    }
    
    static {
        LeafaEntity.entity = (EntityType)EntityType.Builder.func_220322_a(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setUpdateInterval(3).setCustomClientFactory((BiFunction)CustomEntity::new).func_220321_a(0.6f, 1.8f).func_206830_a("leafa").setRegistryName("leafa");
    }
    ...
    private static class EntityAttributesRegisterHandler
    {
        ...
        public void onEntityAttributeCreation(final EntityAttributeCreationEvent event) {
            ...
            event.put(LeafaEntity.entity, ammma.func_233813_a_());
        }
    }
    ...
    public static class CustomEntity extends MonsterEntity
    {
        public CustomEntity(final FMLPlayMessages.SpawnEntity packet, final World world) {
            this((EntityType<CustomEntity>)LeafaEntity.entity, world);
        }
        ...
        public CustomEntity(final EntityType<CustomEntity> type, final World world) {
            ...
            this.func_200203_b((ITextComponent)new StringTextComponent("Leafa"));
