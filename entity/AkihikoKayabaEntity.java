...
import net.mcreator.swordcraftonline.entity.renderer.AkihikoKayabaRenderer;
...
@Tag
public class AkihikoKayabaEntity extends SwordcraftonlineModElements.ModElement
{
    public static EntityType entity;
    
    public AkihikoKayabaEntity(final SwordcraftonlineModElements instance) {
        super(instance, 221);
        FMLJavaModLoadingContext.get().getModEventBus().register((Object)new AkihikoKayabaRenderer.ModelRegisterHandler());
    ...
    public void initElements() {
        this.elements.entities.add(() -> AkihikoKayabaEntity.entity);
        final SpawnEggItem spawnEggItem;
        this.elements.items.add(() -> {
            new SpawnEggItem(AkihikoKayabaEntity.entity, -10066330, -3881788, new Item.Properties().func_200916_a(ItemGroup.field_78026_f));
            return (Item)spawnEggItem.setRegistryName("akihiko_kayaba_spawn_egg");
        });
    }
    ...
    public void addFeatureToBiomes(final BiomeLoadingEvent event) {
        ...
        event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(AkihikoKayabaEntity.entity, 1, 1, 1));
    }
    
    @Override
    public void init(final FMLCommonSetupEvent event) {
        EntitySpawnPlacementRegistry.func_209343_a(AkihikoKayabaEntity.entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.func_180495_p(pos.func_177977_b()).func_185904_a() == Material.field_151577_b && world.func_226659_b_(pos, 0) > 8);
    }
    
    static {
        AkihikoKayabaEntity.entity = (EntityType)EntityType.Builder.func_220322_a(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setUpdateInterval(3).setCustomClientFactory((BiFunction)CustomEntity::new).func_220321_a(0.6f, 1.8f).func_206830_a("akihiko_kayaba").setRegistryName("akihiko_kayaba");
    }
    ...
    private static class EntityAttributesRegisterHandler
    {
        ...
        public void onEntityAttributeCreation(final EntityAttributeCreationEvent event) {
            ...
            event.put(AkihikoKayabaEntity.entity, ammma.func_233813_a_());
        }
    }
    ...
    public static class CustomEntity extends CreatureEntity
    {
        public CustomEntity(final FMLPlayMessages.SpawnEntity packet, final World world) {
            this((EntityType<CustomEntity>)AkihikoKayabaEntity.entity, world);
        }
        ...
        public CustomEntity(final EntityType<CustomEntity> type, final World world) {
            ...
            this.func_200203_b((ITextComponent)new StringTextComponent("Akihiko Kayaba"));
        ...
        protected void func_213333_a(final DamageSource source, final int looting, final boolean recentlyHitIn) {
            ...
            this.func_199701_a_(new ItemStack((IItemProvider)CrystalliteIngotItem.block));
        }
