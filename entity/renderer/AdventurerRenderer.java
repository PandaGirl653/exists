...
import net.mcreator.swordcraftonline.entity.AdventurerEntity;
import net.minecraftforge.client.event.ModelRegistryEvent;
import net.minecraftforge.api.distmarker.Dist;
import net.minecraftforge.api.distmarker.OnlyIn;

@OnlyIn(Dist.CLIENT)
public class AdventurerRenderer
{
    public static class ModelRegisterHandler
    {
        ...
        public void registerModels(final ModelRegistryEvent event) {
            RenderingRegistry.registerEntityRenderingHandler(AdventurerEntity.entity, renderManager -> new MobRenderer(renderManager, new Modelsteve_Modified(), 0.5f) {
                public ResourceLocation func_110775_a(final Entity entity) {
                    return new ResourceLocation("swordcraftonline:textures/aventurero.png");
                }
            });
        }
    }
    
    public static class Modelsteve_Modified extends EntityModel<Entity>
    {
