...
import net.mcreator.swordcraftonline.entity.KiritoBlackSuitEntity;
import net.minecraftforge.client.event.ModelRegistryEvent;
import net.minecraftforge.api.distmarker.Dist;
import net.minecraftforge.api.distmarker.OnlyIn;

@OnlyIn(Dist.CLIENT)
public class KiritoBlackSuitRenderer
{
    public static class ModelRegisterHandler
    {
        ...
        public void registerModels(final ModelRegistryEvent event) {
            RenderingRegistry.registerEntityRenderingHandler(KiritoBlackSuitEntity.entity, renderManager -> {
                final BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0.0f), 0.5f) {
                    public ResourceLocation func_110775_a(final Entity entity) {
                        return new ResourceLocation("swordcraftonline:textures/kiritoblacksuit.png");
                    }
                };
