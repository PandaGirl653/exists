...
import net.mcreator.swordcraftonline.entity.renderer.EijiRenderer;
...
@Tag
public class EijiEntity extends SwordcraftonlineModElements.ModElement
{
    public static EntityType entity;
    
    public EijiEntity(final SwordcraftonlineModElements instance) {
        super(instance, 233);
        FMLJavaModLoadingContext.get().getModEventBus().register((Object)new EijiRenderer.ModelRegisterHandler());
    ...
    public void initElements() {
        this.elements.entities.add(() -> EijiEntity.entity);
        final SpawnEggItem spawnEggItem;
        this.elements.items.add(() -> {
            new SpawnEggItem(EijiEntity.entity, -13757380, -15132345, new Item.Properties().func_200916_a(ItemGroup.field_78026_f));
            return (Item)spawnEggItem.setRegistryName("eiji_spawn_egg");
        });
    }
    ...
    public void addFeatureToBiomes(final BiomeLoadingEvent event) {
        ...
        event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(EijiEntity.entity, 1, 1, 1));
    }
    
    @Override
    public void init(final FMLCommonSetupEvent event) {
        EntitySpawnPlacementRegistry.func_209343_a(EijiEntity.entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.func_180495_p(pos.func_177977_b()).func_185904_a() == Material.field_151577_b && world.func_226659_b_(pos, 0) > 8);
    }
    
    static {
        EijiEntity.entity = (EntityType)EntityType.Builder.func_220322_a(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory((BiFunction)CustomEntity::new).func_220321_a(0.6f, 1.8f).func_206830_a("eiji").setRegistryName("eiji");
    }
    ...
    private static class EntityAttributesRegisterHandler
    {
        ...
        public void onEntityAttributeCreation(final EntityAttributeCreationEvent event) {
            ...
            ammma = ammma.func_233815_a_(Attributes.field_233826_i_, 22.0);
            ammma = ammma.func_233815_a_(Attributes.field_233823_f_, 15.0);
            event.put(EijiEntity.entity, ammma.func_233813_a_());
        }
    }
    ...
    public static class CustomEntity extends CreatureEntity
    {
        public CustomEntity(final FMLPlayMessages.SpawnEntity packet, final World world) {
            this((EntityType<CustomEntity>)EijiEntity.entity, world);
        }
        ...
        public CustomEntity(final EntityType<CustomEntity> type, final World world) {
            ...
            this.func_200203_b((ITextComponent)new StringTextComponent("Eiji"));
