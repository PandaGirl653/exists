...
import net.mcreator.swordcraftonline.entity.renderer.LisbethPinkHairRenderer;
...
@Tag
public class LisbethPinkHairEntity extends SwordcraftonlineModElements.ModElement
{
    public static EntityType entity;
    
    public LisbethPinkHairEntity(final SwordcraftonlineModElements instance) {
        super(instance, 227);
        FMLJavaModLoadingContext.get().getModEventBus().register((Object)new LisbethPinkHairRenderer.ModelRegisterHandler());
    ...
    public void initElements() {
        this.elements.entities.add(() -> LisbethPinkHairEntity.entity);
        final SpawnEggItem spawnEggItem;
        this.elements.items.add(() -> {
            new SpawnEggItem(LisbethPinkHairEntity.entity, -42777, -6672641, new Item.Properties().func_200916_a(ItemGroup.field_78026_f));
            return (Item)spawnEggItem.setRegistryName("lisbeth_pink_hair_spawn_egg");
        });
    }
    ...
    public void addFeatureToBiomes(final BiomeLoadingEvent event) {
        ...
        if (new ResourceLocation("ice_spikes").equals((Object)event.getName())) {
            biomeCriteria = true;
        }
        if (!biomeCriteria) {
            return;
        }
        event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(LisbethPinkHairEntity.entity, 1, 1, 1));
    }
    
    @Override
    public void init(final FMLCommonSetupEvent event) {
        EntitySpawnPlacementRegistry.func_209343_a(LisbethPinkHairEntity.entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.func_180495_p(pos.func_177977_b()).func_185904_a() == Material.field_151577_b && world.func_226659_b_(pos, 0) > 8);
    }
    
    static {
        LisbethPinkHairEntity.entity = (EntityType)EntityType.Builder.func_220322_a(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setUpdateInterval(3).setCustomClientFactory((BiFunction)CustomEntity::new).func_220321_a(0.6f, 1.8f).func_206830_a("lisbeth_pink_hair").setRegistryName("lisbeth_pink_hair");
    }
    ...
    private static class EntityAttributesRegisterHandler
    {
        ...
        public void onEntityAttributeCreation(final EntityAttributeCreationEvent event) {
            ...
            event.put(LisbethPinkHairEntity.entity, ammma.func_233813_a_());
        }
    }
    ...
    public static class CustomEntity extends CreatureEntity
    {
        public CustomEntity(final FMLPlayMessages.SpawnEntity packet, final World world) {
            this((EntityType<CustomEntity>)LisbethPinkHairEntity.entity, world);
        }
        ...
        protected void func_213333_a(final DamageSource source, final int looting, final boolean recentlyHitIn) {
            ...
            this.func_199701_a_(new ItemStack((IItemProvider)Items.field_151043_k));
        }
