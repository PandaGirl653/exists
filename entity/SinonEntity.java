...
import net.mcreator.swordcraftonline.entity.renderer.SinonRenderer;
...
@Tag
public class SinonEntity extends SwordcraftonlineModElements.ModElement
{
    public static EntityType entity;
    
    public SinonEntity(final SwordcraftonlineModElements instance) {
        super(instance, 234);
        FMLJavaModLoadingContext.get().getModEventBus().register((Object)new SinonRenderer.ModelRegisterHandler());
    ...
    public void initElements() {
        this.elements.entities.add(() -> SinonEntity.entity);
        final SpawnEggItem spawnEggItem;
        this.elements.items.add(() -> {
            new SpawnEggItem(SinonEntity.entity, -15553107, -12677889, new Item.Properties().func_200916_a(ItemGroup.field_78026_f));
            return (Item)spawnEggItem.setRegistryName("sinon_spawn_egg");
        });
    }
    ...
    public void addFeatureToBiomes(final BiomeLoadingEvent event) {
        ...
        event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(SinonEntity.entity, 1, 1, 1));
    }
    
    @Override
    public void init(final FMLCommonSetupEvent event) {
        EntitySpawnPlacementRegistry.func_209343_a(SinonEntity.entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.func_180495_p(pos.func_177977_b()).func_185904_a() == Material.field_151577_b && world.func_226659_b_(pos, 0) > 8);
    }
    
    static {
        SinonEntity.entity = (EntityType)EntityType.Builder.func_220322_a(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setUpdateInterval(3).setCustomClientFactory((BiFunction)CustomEntity::new).func_220321_a(0.6f, 1.8f).func_206830_a("sinon").setRegistryName("sinon");
    }
    ...
    public static class CustomEntity extends CreatureEntity
    {
        public CustomEntity(final FMLPlayMessages.SpawnEntity packet, final World world) {
            this((EntityType<CustomEntity>)SinonEntity.entity, world);
        }
        ...
        public CustomEntity(final EntityType<CustomEntity> type, final World world) {
            ...
            this.func_200203_b((ITextComponent)new StringTextComponent("Sinon"));
