...
import net.mcreator.swordcraftonline.item.LongDiamondSwordItem;
...
import net.mcreator.swordcraftonline.entity.renderer.AssassinRenderer;
...
@Tag
public class AssassinEntity extends SwordcraftonlineModElements.ModElement
{
    public static EntityType entity;
    
    public AssassinEntity(final SwordcraftonlineModElements instance) {
        super(instance, 312);
        FMLJavaModLoadingContext.get().getModEventBus().register((Object)new AssassinRenderer.ModelRegisterHandler());
    ...
    public void initElements() {
        this.elements.entities.add(() -> AssassinEntity.entity);
        final SpawnEggItem spawnEggItem;
        this.elements.items.add(() -> {
            new SpawnEggItem(AssassinEntity.entity, -13434829, -16777165, new Item.Properties().func_200916_a(ItemGroup.field_78026_f));
            return (Item)spawnEggItem.setRegistryName("assassin_spawn_egg");
        });
    }
    
    @SubscribeEvent
    public void addFeatureToBiomes(final BiomeLoadingEvent event) {
        event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(AssassinEntity.entity, 20, 1, 3));
    }
    
    @Override
    public void init(final FMLCommonSetupEvent event) {
        EntitySpawnPlacementRegistry.func_209343_a(AssassinEntity.entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MonsterEntity::func_223324_d);
        DungeonHooks.addDungeonMob(AssassinEntity.entity, 180);
    }
    
    static {
        AssassinEntity.entity = (EntityType)EntityType.Builder.func_220322_a(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setUpdateInterval(3).setCustomClientFactory((BiFunction)CustomEntity::new).func_220321_a(0.6f, 1.8f).func_206830_a("assassin").setRegistryName("assassin");
    }
    ...
    private static class EntityAttributesRegisterHandler
    {
        ...
        public void onEntityAttributeCreation(final EntityAttributeCreationEvent event) {
            ...
            ammma = ammma.func_233815_a_(Attributes.field_233818_a_, 60.0);
            ammma = ammma.func_233815_a_(Attributes.field_233826_i_, 15.0);
            ammma = ammma.func_233815_a_(Attributes.field_233823_f_, 2.0);
            ammma = ammma.func_233815_a_(Attributes.field_233820_c_, 0.2);
            ammma = ammma.func_233815_a_(Attributes.field_233824_g_, 0.6);
            event.put(AssassinEntity.entity, ammma.func_233813_a_());
        }
    }
    ...
    public static class CustomEntity extends MonsterEntity
    {
        public CustomEntity(final FMLPlayMessages.SpawnEntity packet, final World world) {
            this((EntityType<CustomEntity>)AssassinEntity.entity, world);
        }
        ...
        public CustomEntity(final EntityType<CustomEntity> type, final World world) {
            ...
            this.func_184201_a(EquipmentSlotType.MAINHAND, new ItemStack((IItemProvider)LongDiamondSwordItem.block));
        }
