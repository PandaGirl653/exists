...
import net.mcreator.swordcraftonline.entity.KiritoAlicizationEntity;
...
import net.mcreator.swordcraftonline.item.KiritoSummonerItem;
...
public class KiritoSummonerRightClickedInAirProcedure
{
    public static void executeProcedure(final Map<String, Object> dependencies) {
        if (dependencies.get("world") == null) {
            if (!dependencies.containsKey("world")) {
                SwordcraftonlineMod.LOGGER.warn("Failed to load dependency world for procedure KiritoSummonerRightClickedInAir!");
            }
            return;
        }
        if (dependencies.get("x") == null) {
            if (!dependencies.containsKey("x")) {
                SwordcraftonlineMod.LOGGER.warn("Failed to load dependency x for procedure KiritoSummonerRightClickedInAir!");
            }
            return;
        }
        if (dependencies.get("y") == null) {
            if (!dependencies.containsKey("y")) {
                SwordcraftonlineMod.LOGGER.warn("Failed to load dependency y for procedure KiritoSummonerRightClickedInAir!");
            }
            return;
        }
        if (dependencies.get("z") == null) {
            if (!dependencies.containsKey("z")) {
                SwordcraftonlineMod.LOGGER.warn("Failed to load dependency z for procedure KiritoSummonerRightClickedInAir!");
            }
            return;
        }
        if (dependencies.get("entity") == null) {
            if (!dependencies.containsKey("entity")) {
                SwordcraftonlineMod.LOGGER.warn("Failed to load dependency entity for procedure KiritoSummonerRightClickedInAir!");
            }
            return;
        }
        ...
        if (world.func_201670_d()) {
            Minecraft.func_71410_x().field_71460_t.func_190565_a(new ItemStack((IItemProvider)KiritoSummonerItem.block));
        }
        ...
        if (world instanceof ServerWorld) {
            final Entity entityToSpawn = (Entity)new KiritoAlicizationEntity.CustomEntity((EntityType<KiritoAlicizationEntity.CustomEntity>)KiritoAlicizationEntity.entity, (World)world);
        ...
        if (entity instanceof PlayerEntity) {
            final ItemStack _stktoremove = new ItemStack((IItemProvider)KiritoSummonerItem.block);
