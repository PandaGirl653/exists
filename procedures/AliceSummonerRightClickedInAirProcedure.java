...
import net.mcreator.swordcraftonline.entity.AliceEntity;
...
import net.mcreator.swordcraftonline.item.AliceSummonerItem;
...
public class AliceSummonerRightClickedInAirProcedure
{
    public static void executeProcedure(final Map<String, Object> dependencies) {
        if (dependencies.get("world") == null) {
            if (!dependencies.containsKey("world")) {
                SwordcraftonlineMod.LOGGER.warn("Failed to load dependency world for procedure AliceSummonerRightClickedInAir!");
            }
            return;
        }
        if (dependencies.get("x") == null) {
            if (!dependencies.containsKey("x")) {
                SwordcraftonlineMod.LOGGER.warn("Failed to load dependency x for procedure AliceSummonerRightClickedInAir!");
            }
            return;
        }
        if (dependencies.get("y") == null) {
            if (!dependencies.containsKey("y")) {
                SwordcraftonlineMod.LOGGER.warn("Failed to load dependency y for procedure AliceSummonerRightClickedInAir!");
            }
            return;
        }
        if (dependencies.get("z") == null) {
            if (!dependencies.containsKey("z")) {
                SwordcraftonlineMod.LOGGER.warn("Failed to load dependency z for procedure AliceSummonerRightClickedInAir!");
            }
            return;
        }
        if (dependencies.get("entity") == null) {
            if (!dependencies.containsKey("entity")) {
                SwordcraftonlineMod.LOGGER.warn("Failed to load dependency entity for procedure AliceSummonerRightClickedInAir!");
            }
            return;
        }
        ...
        if (world.func_201670_d()) {
            Minecraft.func_71410_x().field_71460_t.func_190565_a(new ItemStack((IItemProvider)AliceSummonerItem.block));
        }
        ...
        if (world instanceof ServerWorld) {
            final Entity entityToSpawn = (Entity)new AliceEntity.CustomEntity((EntityType<AliceEntity.CustomEntity>)AliceEntity.entity, (World)world);
        ...
        if (entity instanceof PlayerEntity) {
            final ItemStack _stktoremove = new ItemStack((IItemProvider)AliceSummonerItem.block);
