...
@Tag
public class WhiteDiamondBlockBlock extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:white_diamond_block")
    public static final Block block;
    
    public WhiteDiamondBlockBlock(final SwordcraftonlineModElements instance) {
        super(instance, 68);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            new BlockItem(WhiteDiamondBlockBlock.block, new Item.Properties().func_200916_a(ItemGroup.field_78030_b));
            return (Item)blockItem.setRegistryName(WhiteDiamondBlockBlock.block.getRegistryName());
        });
    }
    ...
    public static class CustomBlock extends Block
    {
        public CustomBlock() {
            ...
            this.setRegistryName("white_diamond_block");
        }
