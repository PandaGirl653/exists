...
@Tag
public class DarkDiamondOreBlock extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:dark_diamond_ore")
    ...
    public DarkDiamondOreBlock(final SwordcraftonlineModElements instance) {
        super(instance, 63);
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            new BlockItem(DarkDiamondOreBlock.block, new Item.Properties().func_200916_a(ItemGroup.field_78030_b));
            return (Item)blockItem.setRegistryName(DarkDiamondOreBlock.block.getRegistryName());
        });
    }
    
    @SubscribeEvent
    public void addFeatureToBiomes(final BiomeLoadingEvent event) {
        event.getGeneration().getFeatures(GenerationStage.Decoration.UNDERGROUND_ORES).add(() -> DarkDiamondOreBlock.configuredFeature);
    }
    
    static {
        block = null;
        DarkDiamondOreBlock.feature = null;
        DarkDiamondOreBlock.configuredFeature = null;
        DarkDiamondOreBlock.CUSTOM_MATCH = null;
    }
    ...
    public static class CustomBlock extends Block
    {
        public CustomBlock() {
            ...
            this.setRegistryName("dark_diamond_ore");
        }
        ...
        public List<ItemStack> func_220076_a(final BlockState state, final LootContext.Builder builder) {
            ...
            return Collections.singletonList(new ItemStack((IItemProvider)DarkDiamondItem.block));
        }
    }
    ...
    private static class CustomRuleTest extends RuleTest
    {
        ...
        protected IRuleTestType<?> func_215180_a() {
            return DarkDiamondOreBlock.CUSTOM_MATCH;
        }
    ...
    private static class FeatureRegisterHandler
    {
        ...
        public void registerFeature(final RegistryEvent.Register<Feature<?>> event) {
            DarkDiamondOreBlock.CUSTOM_MATCH = (IRuleTestType<CustomRuleTest>)Registry.func_218322_a(Registry.field_218363_D, new ResourceLocation("swordcraftonline:dark_diamond_ore_match"), (Object)(() -> CustomRuleTest.codec));
            DarkDiamondOreBlock.feature = (Feature<OreFeatureConfig>)new OreFeature(OreFeatureConfig.field_236566_a_) {
            ...
            DarkDiamondOreBlock.configuredFeature = (ConfiguredFeature<?, ?>)((ConfiguredFeature)((ConfiguredFeature)DarkDiamondOreBlock.feature.func_225566_b_((IFeatureConfig)new OreFeatureConfig((RuleTest)CustomRuleTest.INSTANCE, DarkDiamondOreBlock.block.func_176223_P(), 5)).func_242733_d(11)).func_242728_a()).func_242731_b(1);
            event.getRegistry().register(DarkDiamondOreBlock.feature.setRegistryName("dark_diamond_ore"));
            Registry.func_218322_a(WorldGenRegistries.field_243653_e, new ResourceLocation("swordcraftonline:dark_diamond_ore"), (Object)DarkDiamondOreBlock.configuredFeature);
        }
    }
}
