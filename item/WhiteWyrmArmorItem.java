...
@Tag
public class WhiteWyrmArmorItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:white_wyrm_armor_helmet")
    public static final Item helmet;
    @ObjectHolder("swordcraftonline:white_wyrm_armor_chestplate")
    public static final Item body;
    @ObjectHolder("swordcraftonline:white_wyrm_armor_leggings")
    public static final Item legs;
    @ObjectHolder("swordcraftonline:white_wyrm_armor_boots")
    public static final Item boots;
    
    public WhiteWyrmArmorItem(final SwordcraftonlineModElements instance) {
        super(instance, 204);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            new ArmorItem(x0, EquipmentSlotType.HEAD, new Item.Properties().func_200916_a(SwordCraftOnlineItemGroup.tab)) {
                public String getArmorTexture(final ItemStack stack, final Entity entity, final EquipmentSlotType slot, final String type) {
                    return "swordcraftonline:textures/models/armor/whitewyrm__layer_" + ((slot == EquipmentSlotType.LEGS) ? "2" : "1") + ".png";
                }
            };
            return (Item)armorItem.setRegistryName("white_wyrm_armor_helmet");
        });
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)armorItem2.setRegistryName("white_wyrm_armor_chestplate");
        });
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)armorItem3.setRegistryName("white_wyrm_armor_leggings");
        });
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)armorItem4.setRegistryName("white_wyrm_armor_boots");
        });
    }
