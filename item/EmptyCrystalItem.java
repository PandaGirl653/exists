...
@Tag
public class EmptyCrystalItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:empty_crystal")
    public static final Item block;
    
    public EmptyCrystalItem(final SwordcraftonlineModElements instance) {
        super(instance, 56);
    }
    ...
    {
        public ItemCustom() {
            super(new Item.Properties().func_200916_a(SwordCraftOnlineItemGroup.tab).func_200917_a(16).func_208103_a(Rarity.COMMON));
            this.setRegistryName("empty_crystal");
        }
