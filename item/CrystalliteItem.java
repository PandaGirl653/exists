...
@Tag
public class CrystalliteItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:crystallite")
    public static final Item block;
    
    public CrystalliteItem(final SwordcraftonlineModElements instance) {
        super(instance, 2);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("crystallite");
        }
        ...
        public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
            ...
            list.add((ITextComponent)new StringTextComponent("An Ingot obtained after the Crystallite is smelted."));
        }
    }
}
