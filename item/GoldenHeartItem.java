...
@Tag
public class GoldenHeartItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:golden_heart")
    public static final Item block;
    
    public GoldenHeartItem(final SwordcraftonlineModElements instance) {
        super(instance, 259);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("golden_heart");
        }
