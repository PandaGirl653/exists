...
import net.mcreator.swordcraftonline.procedures.KiritoSummonerRightClickedInAirProcedure;
...
@Tag
public class KiritoSummonerItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:kirito_summoner")
    public static final Item block;
    
    public KiritoSummonerItem(final SwordcraftonlineModElements instance) {
        super(instance, 297);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("kirito_summoner");
        }
        ...
        public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
            ...
            list.add((ITextComponent)new StringTextComponent("§eWith this item you can Summon the Sub Boss Kirito Alicization"));
        }
        ...
        public ActionResult<ItemStack> func_77659_a(final World world, final PlayerEntity entity, final Hand hand) {
            ...
            KiritoSummonerRightClickedInAirProcedure.executeProcedure(Stream.of((AbstractMap.SimpleEntry[])new AbstractMap.SimpleEntry[] { new AbstractMap.SimpleEntry((K)"world", (V)world), new AbstractMap.SimpleEntry((K)"x", (V)x), new AbstractMap.SimpleEntry((K)"y", (V)y), new AbstractMap.SimpleEntry((K)"z", (V)z), new AbstractMap.SimpleEntry((K)"entity", (V)entity) }).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
            return ar;
        }
    }
}
