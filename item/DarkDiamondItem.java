...
@Tag
public class DarkDiamondItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:dark_diamond")
    public static final Item block;
    
    public DarkDiamondItem(final SwordcraftonlineModElements instance) {
        super(instance, 7);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("dark_diamond");
        }
