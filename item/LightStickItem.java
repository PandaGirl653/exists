...
@Tag
public class LightStickItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:light_stick")
    public static final Item block;
    
    public LightStickItem(final SwordcraftonlineModElements instance) {
        super(instance, 14);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("light_stick");
        }
