...
@Tag
public class PinkHeartItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:pink_heart")
    public static final Item block;
    
    public PinkHeartItem(final SwordcraftonlineModElements instance) {
        super(instance, 257);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("pink_heart");
        }
