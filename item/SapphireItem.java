...
@Tag
public class SapphireItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:sapphire")
    public static final Item block;
    
    public SapphireItem(final SwordcraftonlineModElements instance) {
        super(instance, 11);
    }
