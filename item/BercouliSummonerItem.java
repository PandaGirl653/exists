...
import net.mcreator.swordcraftonline.procedures.BercouliSummonerRightClickedInAirProcedure;
...
@Tag
public class BercouliSummonerItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:bercouli_summoner")
    public static final Item block;
    
    public BercouliSummonerItem(final SwordcraftonlineModElements instance) {
        super(instance, 291);
    }
    ...
    {
        public ItemCustom() {
            super(new Item.Properties().func_200916_a(SwordCraftOnlineItemGroup.tab).func_200917_a(1).func_234689_a_().func_208103_a(Rarity.RARE));
            this.setRegistryName("bercouli_summoner");
        }
        ...
        public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
            ...
            list.add((ITextComponent)new StringTextComponent("§eWith this item you can Summon the Sub Boss Bercouli"));
        }
        ...
        public ActionResult<ItemStack> func_77659_a(final World world, final PlayerEntity entity, final Hand hand) {
            ...
            BercouliSummonerRightClickedInAirProcedure.executeProcedure(Stream.of((AbstractMap.SimpleEntry[])new AbstractMap.SimpleEntry[] { new AbstractMap.SimpleEntry((K)"world", (V)world), new AbstractMap.SimpleEntry((K)"x", (V)x), new AbstractMap.SimpleEntry((K)"y", (V)y), new AbstractMap.SimpleEntry((K)"z", (V)z), new AbstractMap.SimpleEntry((K)"entity", (V)entity) }).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
            return ar;
        }
    }
}
