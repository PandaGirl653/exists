...
@Tag
public class SteelItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:steel")
    public static final Item block;
    
    public SteelItem(final SwordcraftonlineModElements instance) {
        super(instance, 5);
    }
