...
@Tag
public class BlueHeartItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:blue_heart")
    public static final Item block;
    
    public BlueHeartItem(final SwordcraftonlineModElements instance) {
        super(instance, 260);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("blue_heart");
        }
