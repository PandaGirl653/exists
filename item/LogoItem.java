...
@Tag
public class LogoItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:logo")
    public static final Item block;
    
    public LogoItem(final SwordcraftonlineModElements instance) {
        super(instance, 61);
    }
    ...
    {
        public ItemCustom() {
            super(new Item.Properties().func_200916_a((ItemGroup)null).func_200917_a(1).func_208103_a(Rarity.COMMON));
