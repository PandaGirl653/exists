...
@Tag
public class PurpleHeartItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:purple_heart")
    public static final Item block;
    
    public PurpleHeartItem(final SwordcraftonlineModElements instance) {
        super(instance, 258);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("purple_heart");
        }
