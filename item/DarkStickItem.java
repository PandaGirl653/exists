...
@Tag
public class DarkStickItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:dark_stick")
    public static final Item block;
    
    public DarkStickItem(final SwordcraftonlineModElements instance) {
        super(instance, 13);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("dark_stick");
        }
