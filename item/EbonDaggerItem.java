...
@Tag
public class EbonDaggerItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:ebon_dagger")
    public static final Item block;
    
    public EbonDaggerItem(final SwordcraftonlineModElements instance) {
        super(instance, 99);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            ...
            }, 3, -1.5f, new Item.Properties().func_200916_a(SwordCraftOnlineItemGroup.tab)) {};
            return (Item)swordItem.setRegistryName("ebon_dagger");
        });
    }
