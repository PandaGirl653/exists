...
@Tag
public class SapphirePickaxeItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:sapphire_pickaxe")
    public static final Item block;
    
    public SapphirePickaxeItem(final SwordcraftonlineModElements instance) {
        super(instance, 93);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)pickaxeItem.setRegistryName("sapphire_pickaxe");
        });
    }
