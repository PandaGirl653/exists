...
@Tag
public class DarkIronItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:dark_iron")
    public static final Item block;
    
    public DarkIronItem(final SwordcraftonlineModElements instance) {
        super(instance, 27);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("dark_iron");
        }
