...
@Tag
public class ElucidatorItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:elucidator")
    public static final Item block;
    
    public ElucidatorItem(final SwordcraftonlineModElements instance) {
        super(instance, 125);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)swordItem.setRegistryName("elucidator");
        });
    }
