...
@Tag
public class ObsidianIngotItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:obsidian_ingot")
    public static final Item block;
    
    public ObsidianIngotItem(final SwordcraftonlineModElements instance) {
        super(instance, 9);
    }
    ...
    {
        public ItemCustom() {
            super(new Item.Properties().func_200916_a(SwordCraftOnlineItemGroup.tab).func_200917_a(64).func_208103_a(Rarity.UNCOMMON));
