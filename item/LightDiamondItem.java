...
@Tag
public class LightDiamondItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:light_diamond")
    public static final Item block;
    
    public LightDiamondItem(final SwordcraftonlineModElements instance) {
        super(instance, 8);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("light_diamond");
        }
