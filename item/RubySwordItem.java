...
@Tag
public class RubySwordItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:ruby_sword")
    public static final Item block;
    
    public RubySwordItem(final SwordcraftonlineModElements instance) {
        super(instance, 79);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)swordItem.setRegistryName("ruby_sword");
        });
    }
