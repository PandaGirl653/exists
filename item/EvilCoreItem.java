...
@Tag
public class EvilCoreItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:evil_core")
    public static final Item block;
    
    public EvilCoreItem(final SwordcraftonlineModElements instance) {
        super(instance, 264);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("evil_core");
        }
        ...
        public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
            ...
            list.add((ITextComponent)new StringTextComponent("§eCore to Summon the Dark Knight."));
        }
    }
}
