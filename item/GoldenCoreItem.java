...
@Tag
public class GoldenCoreItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:golden_core")
    public static final Item block;
    
    public GoldenCoreItem(final SwordcraftonlineModElements instance) {
        super(instance, 263);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("golden_core");
        }
        ...
        public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
            ...
            list.add((ITextComponent)new StringTextComponent("§eCore to Summon the Golden Knight."));
        }
    }
}
