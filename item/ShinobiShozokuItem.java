...
@Tag
public class ShinobiShozokuItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:shinobi_shozoku_helmet")
    public static final Item helmet;
    @ObjectHolder("swordcraftonline:shinobi_shozoku_chestplate")
    public static final Item body;
    @ObjectHolder("swordcraftonline:shinobi_shozoku_leggings")
    public static final Item legs;
    @ObjectHolder("swordcraftonline:shinobi_shozoku_boots")
    public static final Item boots;
    
    public ShinobiShozokuItem(final SwordcraftonlineModElements instance) {
        super(instance, 194);
    }
    ...
    public void initElements() {
        final IArmorMaterial armormaterial = (IArmorMaterial)new IArmorMaterial() {
            public int func_200896_a(final EquipmentSlotType slot) {
                return (new int[] { 13, 15, 16, 11 })[slot.func_188454_b()] * 20;
            }
            
            public int func_200902_b(final EquipmentSlotType slot) {
                return (new int[] { 3, 6, 7, 3 })[slot.func_188454_b()];
            }
        ...
        this.elements.items.add(() -> {
            new ArmorItem(x0, EquipmentSlotType.HEAD, new Item.Properties().func_200916_a(SwordCraftOnlineItemGroup.tab)) {
                public String getArmorTexture(final ItemStack stack, final Entity entity, final EquipmentSlotType slot, final String type) {
                    return "swordcraftonline:textures/models/armor/shinobishozoku__layer_" + ((slot == EquipmentSlotType.LEGS) ? "2" : "1") + ".png";
                }
            };
            return (Item)armorItem.setRegistryName("shinobi_shozoku_helmet");
        });
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)armorItem2.setRegistryName("shinobi_shozoku_chestplate");
        });
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)armorItem3.setRegistryName("shinobi_shozoku_leggings");
        });
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)armorItem4.setRegistryName("shinobi_shozoku_boots");
        });
    }
