...
@Tag
public class CrystalliteStickItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:crystallite_stick")
    public static final Item block;
    
    public CrystalliteStickItem(final SwordcraftonlineModElements instance) {
        super(instance, 17);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("crystallite_stick");
        }
