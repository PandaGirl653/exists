...
@Tag
public class DarkDiamondPowderItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:dark_diamond_powder")
    public static final Item block;
    
    public DarkDiamondPowderItem(final SwordcraftonlineModElements instance) {
        super(instance, 20);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("dark_diamond_powder");
        }
