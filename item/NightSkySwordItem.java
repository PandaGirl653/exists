...
import net.mcreator.swordcraftonline.procedures.NightSkySwordToolInHandTickProcedure;
import net.minecraft.entity.Entity;
import net.mcreator.swordcraftonline.procedures.NightSkySwordRightClickedInAirProcedure;
...
@Tag
public class NightSkySwordItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:night_sky_sword")
    public static final Item block;
    
    public NightSkySwordItem(final SwordcraftonlineModElements instance) {
        super(instance, 136);
    }
        ...
        this.elements.items.add(() -> {
            new SwordItem(new IItemTier() {
                ...
                public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
                    ...
                    list.add((ITextComponent)new StringTextComponent("§fGives you Strength for a short period of time."));
                    list.add((ITextComponent)new StringTextComponent("§ePassive:"));
                    list.add((ITextComponent)new StringTextComponent("§fGives you Night Vision."));
                }
                ...
                public ActionResult<ItemStack> func_77659_a(final World world, final PlayerEntity entity, final Hand hand) {
                    ...
                    NightSkySwordRightClickedInAirProcedure.executeProcedure(Stream.of((AbstractMap.SimpleEntry[])new AbstractMap.SimpleEntry[] { new AbstractMap.SimpleEntry((K)"entity", (V)entity), new AbstractMap.SimpleEntry((K)"itemstack", (V)itemstack) }).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
                ...
                public void func_77663_a(final ItemStack itemstack, final World world, final Entity entity, final int slot, final boolean selected) {
                    ...
                    final double z = entity.func_226281_cx_();
                    if (selected) {
                        NightSkySwordToolInHandTickProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<String, Entity>("entity", entity)).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
                    }
                }
            };
            return (Item)swordItem.setRegistryName("night_sky_sword");
        });
    }
