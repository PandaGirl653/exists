...
@Tag
public class RefinedSteelItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:refined_steel")
    public static final Item block;
    
    public RefinedSteelItem(final SwordcraftonlineModElements instance) {
        super(instance, 186);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("refined_steel");
        }
