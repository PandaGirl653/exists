...
import net.mcreator.swordcraftonline.procedures.AliceSummonerRightClickedInAirProcedure;
...
@Tag
public class AliceSummonerItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:alice_summoner")
    public static final Item block;
    
    public AliceSummonerItem(final SwordcraftonlineModElements instance) {
        super(instance, 289);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("alice_summoner");
        }
        ...
        public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
            ...
            list.add((ITextComponent)new StringTextComponent("§eWith this item you can Summon the Sub Boss Alice"));
        }
