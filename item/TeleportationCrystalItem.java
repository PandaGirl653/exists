...
import net.mcreator.swordcraftonline.procedures.TeleportationCrystalRightClickedInAirProcedure;
...
@Tag
public class TeleportationCrystalItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:teleportation_crystal")
    public static final Item block;
    
    public TeleportationCrystalItem(final SwordcraftonlineModElements instance) {
        super(instance, 48);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("teleportation_crystal");
        }
        ...
        public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
            ...
            list.add((ITextComponent)new StringTextComponent("This Crystal takes you to your Repair point."));
        }
        ...
        public ActionResult<ItemStack> func_77659_a(final World world, final PlayerEntity entity, final Hand hand) {
            ...
            TeleportationCrystalRightClickedInAirProcedure.executeProcedure(Stream.of((AbstractMap.SimpleEntry[])new AbstractMap.SimpleEntry[] { new AbstractMap.SimpleEntry((K)"world", (V)world), new AbstractMap.SimpleEntry((K)"entity", (V)entity), new AbstractMap.SimpleEntry((K)"itemstack", (V)itemstack) }).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
            return ar;
        }
    }
}
