...
@Tag
public class CrystalliteAxeItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:crystallite_axe")
    public static final Item block;
    
    public CrystalliteAxeItem(final SwordcraftonlineModElements instance) {
        super(instance, 153);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            ...
            }, 1.0f, -3.1f, new Item.Properties().func_200916_a(SwordCraftOnlineItemGroup.tab).func_234689_a_()) {};
            return (Item)axeItem.setRegistryName("crystallite_axe");
        });
    }
