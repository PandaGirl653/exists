...
@Tag
public class LightDiamondPowderItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:light_diamond_powder")
    public static final Item block;
    
    public LightDiamondPowderItem(final SwordcraftonlineModElements instance) {
        super(instance, 19);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("light_diamond_powder");
        }
