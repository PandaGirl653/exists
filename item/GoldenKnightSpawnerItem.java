...
import net.mcreator.swordcraftonline.procedures.GoldenKnightSpawnerRightClickedInAirProcedure;
...
@Tag
public class GoldenKnightSpawnerItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:golden_knight_spawner")
    public static final Item block;
    
    public GoldenKnightSpawnerItem(final SwordcraftonlineModElements instance) {
        super(instance, 269);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("golden_knight_spawner");
        }
        ...
        public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
            ...
            list.add((ITextComponent)new StringTextComponent("§eSummoning the Golden Knight"));
        }
        ...
        public ActionResult<ItemStack> func_77659_a(final World world, final PlayerEntity entity, final Hand hand) {
            ...
            GoldenKnightSpawnerRightClickedInAirProcedure.executeProcedure(Stream.of((AbstractMap.SimpleEntry[])new AbstractMap.SimpleEntry[] { new AbstractMap.SimpleEntry((K)"world", (V)world), new AbstractMap.SimpleEntry((K)"x", (V)x), new AbstractMap.SimpleEntry((K)"y", (V)y), new AbstractMap.SimpleEntry((K)"z", (V)z), new AbstractMap.SimpleEntry((K)"entity", (V)entity) }).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
            return ar;
        }
    }
}
