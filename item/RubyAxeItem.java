...
@Tag
public class RubyAxeItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:ruby_axe")
    public static final Item block;
    
    public RubyAxeItem(final SwordcraftonlineModElements instance) {
        super(instance, 81);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)axeItem.setRegistryName("ruby_axe");
        });
    }
