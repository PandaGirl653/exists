...
@Tag
public class DarkLeatherItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:dark_leather")
    public static final Item block;
    
    public DarkLeatherItem(final SwordcraftonlineModElements instance) {
        super(instance, 23);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("dark_leather");
        }
