...
@Tag
public class KnightArmorItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:knight_armor_helmet")
    public static final Item helmet;
    @ObjectHolder("swordcraftonline:knight_armor_chestplate")
    public static final Item body;
    @ObjectHolder("swordcraftonline:knight_armor_leggings")
    public static final Item legs;
    @ObjectHolder("swordcraftonline:knight_armor_boots")
    public static final Item boots;
    
    public KnightArmorItem(final SwordcraftonlineModElements instance) {
        super(instance, 189);
    }
    ...
    public void initElements() {
        final IArmorMaterial armormaterial = (IArmorMaterial)new IArmorMaterial() {
            public int func_200896_a(final EquipmentSlotType slot) {
                return (new int[] { 13, 15, 16, 11 })[slot.func_188454_b()] * 16;
            }
        ...
        this.elements.items.add(() -> {
            new ArmorItem(x0, EquipmentSlotType.HEAD, new Item.Properties().func_200916_a(SwordCraftOnlineItemGroup.tab)) {
                public String getArmorTexture(final ItemStack stack, final Entity entity, final EquipmentSlotType slot, final String type) {
                    return "swordcraftonline:textures/models/armor/caballero__layer_" + ((slot == EquipmentSlotType.LEGS) ? "2" : "1") + ".png";
                }
            };
            return (Item)armorItem.setRegistryName("knight_armor_helmet");
        });
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)armorItem2.setRegistryName("knight_armor_chestplate");
        });
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)armorItem3.setRegistryName("knight_armor_leggings");
        });
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)armorItem4.setRegistryName("knight_armor_boots");
        });
    }
