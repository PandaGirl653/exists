...
@Tag
public class CrystalliteIngotItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:crystallite_ingot")
    public static final Item block;
    
    public CrystalliteIngotItem(final SwordcraftonlineModElements instance) {
        super(instance, 1);
    }
    ...
    {
        public ItemCustom() {
            super(new Item.Properties().func_200916_a(SwordCraftOnlineItemGroup.tab).func_200917_a(64).func_208103_a(Rarity.EPIC));
            this.setRegistryName("crystallite_ingot");
        }
        ...
        public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
            ...
            list.add((ITextComponent)new StringTextComponent("This Crystal can only be obtained in mines and..."));
        }
    }
}
