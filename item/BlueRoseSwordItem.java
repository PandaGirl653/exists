...
import net.mcreator.swordcraftonline.procedures.BlueRoseSwordToolInHandTickProcedure;
import net.minecraft.entity.Entity;
import net.mcreator.swordcraftonline.procedures.BlueRoseSwordLivingEntityIsHitWithToolProcedure;
...
@Tag
public class BlueRoseSwordItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:blue_rose_sword")
    public static final Item block;
    
    public BlueRoseSwordItem(final SwordcraftonlineModElements instance) {
        super(instance, 132);
    }
        ...
        this.elements.items.add(() -> {
            new SwordItem(new IItemTier() {
                ...
                public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
                    ...
                    list.add((ITextComponent)new StringTextComponent("§fHitting gives the enemy slowness."));
                    list.add((ITextComponent)new StringTextComponent("§ePassive:"));
                    list.add((ITextComponent)new StringTextComponent("§fPassively gives you the Dolphin's Grace effect."));
                }
                ...
                public boolean func_77644_a(final ItemStack itemstack, final LivingEntity entity, final LivingEntity sourceentity) {
                    ...
                    BlueRoseSwordLivingEntityIsHitWithToolProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<String, LivingEntity>("entity", entity)).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
                    return retval;
                }
                ...
                public void func_77663_a(final ItemStack itemstack, final World world, final Entity entity, final int slot, final boolean selected) {
                    ...
                    final double z = entity.func_226281_cx_();
                    if (selected) {
                        BlueRoseSwordToolInHandTickProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<String, Entity>("entity", entity)).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
                    }
                }
            };
            return (Item)swordItem.setRegistryName("blue_rose_sword");
        });
    }
