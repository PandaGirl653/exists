...
@Tag
public class RubyShovelItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:ruby_shovel")
    public static final Item block;
    
    public RubyShovelItem(final SwordcraftonlineModElements instance) {
        super(instance, 87);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)shovelItem.setRegistryName("ruby_shovel");
        });
    }
