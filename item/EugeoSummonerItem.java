...
import net.mcreator.swordcraftonline.procedures.EugeoSummonerRightClickedInAirProcedure;
...
@Tag
public class EugeoSummonerItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:eugeo_summoner")
    public static final Item block;
    
    public EugeoSummonerItem(final SwordcraftonlineModElements instance) {
        super(instance, 293);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("eugeo_summoner");
        }
        ...
        public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
            ...
            list.add((ITextComponent)new StringTextComponent("§eWith this item you can Summon the Sub Boss Eugeo"));
        }
        ...
        public ActionResult<ItemStack> func_77659_a(final World world, final PlayerEntity entity, final Hand hand) {
            ...
            EugeoSummonerRightClickedInAirProcedure.executeProcedure(Stream.of((AbstractMap.SimpleEntry[])new AbstractMap.SimpleEntry[] { new AbstractMap.SimpleEntry((K)"world", (V)world), new AbstractMap.SimpleEntry((K)"x", (V)x), new AbstractMap.SimpleEntry((K)"y", (V)y), new AbstractMap.SimpleEntry((K)"z", (V)z), new AbstractMap.SimpleEntry((K)"entity", (V)entity) }).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
            return ar;
        }
    }
}
