...
@Tag
public class SilentLightItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:silent_light")
    public static final Item block;
    
    public SilentLightItem(final SwordcraftonlineModElements instance) {
        super(instance, 113);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)swordItem.setRegistryName("silent_light");
        });
    }
