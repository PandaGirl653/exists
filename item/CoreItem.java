...
@Tag
public class CoreItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:core")
    public static final Item block;
    
    public CoreItem(final SwordcraftonlineModElements instance) {
        super(instance, 261);
    }
