...
import net.mcreator.swordcraftonline.procedures.FanatioSummonerRightClickedInAirProcedure;
...
@Tag
public class FanatioSummonerItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:fanatio_summoner")
    public static final Item block;
    
    public FanatioSummonerItem(final SwordcraftonlineModElements instance) {
        super(instance, 295);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("fanatio_summoner");
        }
        ...
        public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
            ...
            list.add((ITextComponent)new StringTextComponent("§eWith this item you can Summon the Sub Boss Fanatio"));
        }
