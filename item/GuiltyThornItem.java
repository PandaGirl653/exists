...
@Tag
public class GuiltyThornItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:guilty_thorn")
    public static final Item block;
    
    public GuiltyThornItem(final SwordcraftonlineModElements instance) {
        super(instance, 107);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            ...
            return (Item)swordItem.setRegistryName("guilty_thorn");
        });
    }
