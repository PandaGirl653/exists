...
import net.mcreator.swordcraftonline.procedures.ObjectEraserToolInHandTickProcedure;
import net.minecraft.entity.Entity;
import net.mcreator.swordcraftonline.procedures.ObjectEraserRightClickedInAirProcedure;
...
@Tag
public class ObjectEraserItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:object_eraser")
    public static final Item block;
    
    public ObjectEraserItem(final SwordcraftonlineModElements instance) {
        super(instance, 167);
    }
        ...
        this.elements.items.add(() -> {
            new SwordItem(new IItemTier() {
                ...
                public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
                    ...
                    list.add((ITextComponent)new StringTextComponent("§f- The wearer gains the strength of \"HERCULES\" for 15 seconds. (has a 15 minute cooldown)"));
                    list.add((ITextComponent)new StringTextComponent("§5Passive:"));
                    list.add((ITextComponent)new StringTextComponent("§fThe wearer gains Toughness 4 only when holding it in hand."));
                }
                ...
                public ActionResult<ItemStack> func_77659_a(final World world, final PlayerEntity entity, final Hand hand) {
                    ...
                    ObjectEraserRightClickedInAirProcedure.executeProcedure(Stream.of((AbstractMap.SimpleEntry[])new AbstractMap.SimpleEntry[] { new AbstractMap.SimpleEntry((K)"entity", (V)entity), new AbstractMap.SimpleEntry((K)"itemstack", (V)itemstack) }).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
                ...
                public void func_77663_a(final ItemStack itemstack, final World world, final Entity entity, final int slot, final boolean selected) {
                    ...
                    final double z = entity.func_226281_cx_();
                    if (selected) {
                        ObjectEraserToolInHandTickProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<String, Entity>("entity", entity)).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
                    }
                }
            };
            return (Item)swordItem.setRegistryName("object_eraser");
        });
    }
