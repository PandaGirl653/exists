...
@Tag
public class EmptyVialItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:empty_vial")
    public static final Item block;
    
    public EmptyVialItem(final SwordcraftonlineModElements instance) {
        super(instance, 33);
    }
    ...
    public static class ItemCustom extends Item
    {
        public ItemCustom() {
            ...
            this.setRegistryName("empty_vial");
        }
