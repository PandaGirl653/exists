...
import net.mcreator.swordcraftonline.procedures.HeavenPiercingSwordToolInHandTickProcedure;
import net.minecraft.entity.Entity;
import net.mcreator.swordcraftonline.procedures.HeavenPiercingSwordRightClickedInAirProcedure;
...
@Tag
public class HeavenPiercingSwordItem extends SwordcraftonlineModElements.ModElement
{
    @ObjectHolder("swordcraftonline:heaven_piercing_sword")
    public static final Item block;
    
    public HeavenPiercingSwordItem(final SwordcraftonlineModElements instance) {
        super(instance, 137);
    }
        ...
        this.elements.items.add(() -> {
            new SwordItem(new IItemTier() {
                ...
                public void func_77624_a(final ItemStack itemstack, final World world, final List<ITextComponent> list, final ITooltipFlag flag) {
                    ...
                    list.add((ITextComponent)new StringTextComponent("§fEliminate the storms and make the day."));
                    list.add((ITextComponent)new StringTextComponent("§ePassive:"));
                    list.add((ITextComponent)new StringTextComponent("§fYou gain Strength and have Saturation."));
                }
                ...
                public ActionResult<ItemStack> func_77659_a(final World world, final PlayerEntity entity, final Hand hand) {
                    ...
                    HeavenPiercingSwordRightClickedInAirProcedure.executeProcedure(Stream.of((AbstractMap.SimpleEntry[])new AbstractMap.SimpleEntry[] { new AbstractMap.SimpleEntry((K)"world", (V)world), new AbstractMap.SimpleEntry((K)"x", (V)x), new AbstractMap.SimpleEntry((K)"y", (V)y), new AbstractMap.SimpleEntry((K)"z", (V)z), new AbstractMap.SimpleEntry((K)"entity", (V)entity), new AbstractMap.SimpleEntry((K)"itemstack", (V)itemstack) }).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
                ...
                public void func_77663_a(final ItemStack itemstack, final World world, final Entity entity, final int slot, final boolean selected) {
                    ...
                    final double z = entity.func_226281_cx_();
                    if (selected) {
                        HeavenPiercingSwordToolInHandTickProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<String, Entity>("entity", entity)).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
                    }
                }
            };
            return (Item)swordItem.setRegistryName("heaven_piercing_sword");
        });
    }
